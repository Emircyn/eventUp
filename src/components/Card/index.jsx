...
const Card = () => {
  return (
    <div className="mb-10 flex flex-col items-center justify-around gap-9 rounded-lg  bg-cardBG bg-card-pattern bg-center py-14 px-6 lg:flex-row lg:px-6 lg:py-12">
